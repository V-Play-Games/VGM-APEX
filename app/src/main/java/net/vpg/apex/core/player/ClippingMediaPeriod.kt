...
public final class ClippingMediaPeriod implements MediaPeriod, MediaPeriod.Callback {
     ...
     */
    public void setClippingError(ClippingMediaSource.@org.jetbrains.annotations.Nullable IllegalClippingException clippingError) {
        this.clippingError = clippingError;
    }

    @Override
    public void prepare(MediaPeriod.@NotNull Callback callback, long positionUs) {
    ...
    @Override
    public @NotNull List<StreamKey> getStreamKeys(@NotNull List<ExoTrackSelection> trackSelections) {
        return mediaPeriod.getStreamKeys(trackSelections);
    }

    @Override
    public @NotNull TrackGroupArray getTrackGroups() {
        return mediaPeriod.getTrackGroups();
    }

    @Override
    public long selectTracks(
        @NullableType ExoTrackSelection @NotNull [] selections,
        boolean @NotNull [] mayRetainStreamFlags,
        @NullableType SampleStream[] streams,
        boolean @NotNull [] streamResetFlags,
        long positionUs) {
    ...
    @Override
    public long getAdjustedSeekPositionUs(long positionUs, @NotNull SeekParameters seekParameters) {
    ...
    @Override
    public boolean continueLoading(@NotNull LoadingInfo loadingInfo) {
    ...
    @Override
    public void onPrepared(@NotNull MediaPeriod mediaPeriod) {
        if (clippingError != null) {
            return;
        }
    ...
    private final class ClippingSampleStream implements SampleStream {
        ...
        @Override
        public int readData(
            @NotNull FormatHolder formatHolder, @NotNull DecoderInputBuffer buffer, @ReadFlags int readFlags) {
            if (isPendingInitialDiscontinuity()) {
