package net.vplaygames.apex.ui.components.common
...
import net.vplaygames.apex.core.di.rememberSetting
...
import net.vplaygames.apex.ui.screens.AlbumInfoRoute
import net.vplaygames.apex.util.bounceClick
...
fun AlbumBar(apexAlbum: ApexAlbum) {
    ...
    Row(
        ...
        modifier = Modifier
            ...
            .bounceClick { navManager.navigate(AlbumInfoRoute(apexAlbum)) }
    ) {
        AlbumImage(apexAlbum, size = gridSize.barSize, cornerRadius = 0)
